<template>
    ...
    <p>Last updated: Sebtember 9, 2024</p>
    ...
    <ul>
    <li>
    <p><strong>Application</strong> refers to Audio Event Detector App or Events SMS Alerts Viewer App, the software program provided by the Company.</p>
    </li>
    <li>
